...
import xyz.yhsj.yhutils.db.annotation.*;
import xyz.yhsj.yhutils.db.annotation.Column;
import xyz.yhsj.yhutils.db.annotation.Finder;
import xyz.yhsj.yhutils.db.annotation.Foreign;
import xyz.yhsj.yhutils.db.annotation.Id;
import xyz.yhsj.yhutils.db.converter.ColumnConverter;
import xyz.yhsj.yhutils.db.converter.ColumnConverterFactory;
import xyz.yhsj.yhutils.db.sqlite.FinderLazyLoader;
import xyz.yhsj.yhutils.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(xyz.yhsj.yhutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(xyz.yhsj.yhutils.db.table.Finder finderColumn) {
