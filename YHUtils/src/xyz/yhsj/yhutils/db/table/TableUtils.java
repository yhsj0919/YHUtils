...
import xyz.yhsj.yhutils.db.annotation.Table;
...
public class TableUtils {
	 ...
	 * key: entityType.name
	 */
	private static ConcurrentHashMap<String, xyz.yhsj.yhutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, xyz.yhsj.yhutils.db.table.Id>();

	/* package */
	static synchronized xyz.yhsj.yhutils.db.table.Id getId(Class<?> entityType) {
		if (Object.class.equals(entityType)) {
		...
		xyz.yhsj.yhutils.db.table.Id id = new xyz.yhsj.yhutils.db.table.Id(
	...
	private static String getPrimaryKeyFieldName(Class<?> entityType) {
		xyz.yhsj.yhutils.db.table.Id id = getId(entityType);
