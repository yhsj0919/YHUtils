...
package xyz.yhsj.yhutils.bitmap.callback;
...
public abstract class BitmapLoadCallBack<T extends View> {
	 ...
	 * @param config
	 */
	public void onLoadStarted(T container, String uri,
	 ...
	 * @param current
	 */
	public void onLoading(T container, String uri, BitmapDisplayConfig config,
	 ...
	 * @param config
	 */
	public abstract void onLoadCompleted(T container, String uri,
	...
	public void setBitmap(T container, Bitmap bitmap) {
		if (bitmapSetter != null) {
			...
			container.setBackgroundDrawable(new BitmapDrawable(container
					.getResources(), bitmap));
		}
	}
