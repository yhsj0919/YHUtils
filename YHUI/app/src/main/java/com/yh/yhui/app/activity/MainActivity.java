...
import com.yh.yhui.app.fragment.*;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setDrawer(Bundle savedInstanceState) {
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withName("主页").withIdentifier(1).withBadge("5").withIcon(GoogleMaterial.Icon.gmd_notifications),
                        new PrimaryDrawerItem().withName("DBUtils").withIdentifier(2).withIcon(GoogleMaterial.Icon.gmd_local_phone),
                        ...
                        new SectionDrawerItem().withName("我自己的工具"),
                    ...
                    public boolean onItemClick(AdapterView<?> parent, View view, int position, long id, final IDrawerItem drawerItem) {
                        if (drawerItem != null && drawerItem instanceof Nameable) {
                            ...
                            switch (drawerItem.getIdentifier()) {
                                case 1:
                                    chengeAty(new Fragment_Main(((Nameable) drawerItem).getName()), R.color.colorPrimary);
                                    toolbar.getMenu().clear();
                                    toolbar.inflateMenu(R.menu.menu_main);
                                    break;
                                case 2:
                                    chengeAty(new Fragment_Utils_DB(), R.color.colorPrimary);
                                    toolbar.getMenu().clear();
    ...
    public void onEvent(Event_Test event) {
