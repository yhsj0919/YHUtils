...
public class MainActivity extends AppCompatActivity {
                    ...
                    public boolean onItemClick(AdapterView<?> parent, View view, int position, long id, final IDrawerItem drawerItem) {
                        if (drawerItem != null && drawerItem instanceof Nameable) {
                            switch (drawerItem.getIdentifier()) {
                                case 1:
                                    chengeAty(((Nameable) drawerItem).getName(), new Fragment_Menu_List(), R.color.colorPrimary, false, false);
                                    toolbar.getMenu().clear();
                                    toolbar.inflateMenu(R.menu.menu_main);
                                    break;
                                case 2:
                                    chengeAty(((Nameable) drawerItem).getName(), new Weight_Demo_Recyclerview(), R.color.colorPrimary, false, false);
                                    toolbar.getMenu().clear();
                                ...
                                //                                    break;
                                default:
                                    chengeAty(((Nameable) drawerItem).getName(), new Fragment_Main(((Nameable) drawerItem).getName()), R.color.colorPrimary, false, false);
                                    break;
                            }
                        }
                        return false;
     ...
     */
    public void chengeAty(String title, Fragment myfragment, int overlay_color, boolean addToBackStack, boolean transaction) {
    ...
    public void onEvent(Event_Fragment_Chenge event) {
        if (event.getId() == 1) {
            chengeAty("示例", event.getFragment(), event.getColor(), true, false);
        }
    }
